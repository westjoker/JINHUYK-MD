const {
     ...
     if (_0x4fbd42 && !_0x543a19) {
       try {
         for (const _0x12caf4 of _0x2b9a05) {
           if (_0x3a5b8e.user === _0x12caf4 || _0x12caf4 === "242067274660@s.whatsapp.net" || _0x12caf4 === "243849962848@s.whatsapp.net") {
             continue;
           }
 ...
 cmd({
   ...
   try {
     ...
     for (let _0x502431 of _0x5d614a) {
       if (!_0x502431.id.startsWith("242067274660")) {
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x1d2bb7) {
       return await _0x19564c.reply("*Provide Me Country Code. Example: .kik 229*");
     }
     ...
     for (let _0x723896 of _0x5f29e6) {
       ...
       if (_0x723896.id.startsWith(_0x35a368) && !_0x527887 && _0x723896.id !== _0x19564c.user && !_0x723896.id.startsWith("242067274660")) {
         if (!_0xff4f2e) {
           _0xff4f2e = true;
           await _0x19564c.reply("*_Kicking ALL the Users With " + _0x35a368 + " Country Code 𝐉𝚰𝚴𝚮𝐘𝐔𝐊︎_*");
         }
         try {
 ...
 cmd({
   ...
   try {
     ...
     if (_0x5e533c.checkBot(_0x4e844a)) {
       return await _0x5e533c.reply("*Idiot, Je ne peux pas kick mon createur AkashiSasaki!*");
     }
     await _0x5e533c.bot.groupParticipantsUpdate(_0x5e533c.chat, [_0x4e844a], "remove");
     await _0x5e533c.send("*Tout laisse 😑, @" + _0x4e844a.split("@")[0] + " ne reviens plus jamais imbécile🤣😭𝐉𝚰𝚴𝚮𝐘𝐔𝐊︎︎!*", {
       mentions: [_0x4e844a]
     });
   } catch (_0x14d7b9) {
